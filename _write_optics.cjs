...
const fs = require('fs')
const dest = 'c:/Users/KDVON/CodeBuddy/20260422231627/portfolio-frontend/src/utils/OpticsEngine.js'
...
export class OpticsEngine {
  ...
  // ── setBaseColor  (optional: tint card surface) ──────────────
  setBaseColor(r, g, b) {
    if (this.material)
      this.material.uniforms.uBaseColor.value.set(r, g, b)
  }

  // ── setFresnelR0  (0.04 = glass/plastic, 0.9 = mirror) ───────
  setFresnelR0(r0) {
    if (this.material)
      this.material.uniforms.uFresnelR0.value = r0
  }
...
console.log('OpticsEngine.js written:', fs.statSync(dest).size, 'bytes')

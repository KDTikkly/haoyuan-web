<template>
  ...
  >
    <!-- 卡片主体 -->
    <div class="lc-card" ref="cardEl">
      <!-- WebGL Canvas 物理光学层（绝对覆盖，pointer-events:none） -->
      <canvas class="lc-shader-canvas" ref="shaderCanvasEl" aria-hidden="true"></canvas>
      ...
      <!-- 按压涟漪 -->
      <div class="lc-press-ring" :class="{ active: isPressed }" aria-hidden="true"></div>
    </div>

    <!-- 详情展开 Modal -->
    <Teleport to="body">
      <Transition name="lc-unfurl">
        <div
          v-if="showDetail"
          class="lc-detail-backdrop"
          @click.self="closeDetail"
          role="dialog"
          aria-modal="true"
        >
          <div class="lc-detail-panel">
            <!-- 顶栏 -->
            <div class="lc-detail-header">
              <span class="lc-detail-tag">LIGHT CONE</span>
              <span class="lc-detail-id">{{ coneId }}</span>
              <button class="lc-detail-close" @click="closeDetail" aria-label="Close">ESC</button>
            </div>

            <!-- 正文 -->
            <div class="lc-detail-body">
              <slot name="detail">
                <p class="lc-detail-placeholder">// No detail data provided.</p>
              </slot>
            </div>

            <!-- 底部属性列 -->
            <div class="lc-detail-footer">
              <div v-for="attr in attrs" :key="attr.label" class="lc-detail-attr">
                <span class="lc-detail-attr-label">{{ attr.label }}</span>
                <span class="lc-detail-attr-value">{{ attr.value }}</span>
              </div>
            </div>
          </div>
        </div>
